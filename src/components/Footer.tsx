...
const COLS = [
  {
    title: "Community",
    items: [
      { label: "RSVP on Luma", href: links.luma, external: true },
      { label: "WhatsApp group", href: links.whatsapp, external: true },
    ...
    <footer className="bg-night text-cream-dim">
      <div className="mx-auto max-w-6xl px-5 py-16 sm:px-8">
        <div className="grid gap-10 md:grid-cols-[1.4fr_1fr_1fr]">
          <div>
            <Logo tone="dark" />
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-cream-dim/80">
        ...
        <div className="mt-14 flex flex-col gap-3 border-t border-night-line pt-6 text-xs text-cream-dim/60 sm:flex-row sm:items-center sm:justify-between">
          <p>
            © {brand.founded} {brand.name}. A nonprofit community. AI for everyone.
          </p>
          <p>Built in the open in Oslo.</p>
        </div>
      </div>
    </footer>
  );
